function [theta,lambda0_n,itin]=argminsn_np(s_hat,theta,theta0_n,lambda0_n,rho,l_n,MAXIT_in,TOL,EPS,p)
I=eye(p);
%theta=zeros(p);
theta0=theta0_n;
theta1=theta0;
...
for iter=1:MAXIT_in
    ...
    %lambda1_o=lambda1;
    %theta
    theta=G_1(s_hat+3*rho*I,I+rho*(theta0+theta1+theta0_n)-lambda0-lambda1-lambda0_n);
